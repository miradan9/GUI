package GUI.SettingPptionButton;
...
public class MarcoBotonOpcion extends JFrame
{
    ...
    private final Font tipoLetraNegritaCursiva; // tipo de letra para texto ennegrita y cursiva
    ...
    {
        private Font tipoLetra; // tipo de letra asociado con este componentede escucha
